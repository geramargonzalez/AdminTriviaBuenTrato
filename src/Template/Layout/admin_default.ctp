...
<!-- AdminLTE Skins. Choose a skin from the css/skins
    ...
    <?= $this->Html->css('../plugins/datepicker/css/datepicker'); ?>
    <?= $this->Html->css('../plugins/select2/css/select2.min'); ?>
    <?= $this->Html->css('../plugins/wysihtml5/css/wysihtml5.min'); ?>
...
<!-- SlimScroll -->
<?php echo $this->Html->script('../plugins/jquery.slimscroll.min'); ?>
<!-- Cookies -->
...
<?= $this->Html->script('../plugins/wysihtml5/js/wysihtml5.min'); ?>
<?= $this->Html->script('selectQuestion'); ?>
<?= $this->fetch('script'); ?>
